                    ...
                    return (
                      ...
                      >
                        <Link
                          ...
                          onMouseLeave={(e) => {
                            if (index === 0) {
                              e.target.style.color = "#00141F";
                              e.target.style.fontWeight =
                                subm.description === "TBD" ? "normal" : "bold";
                            }
                          ...
                          <ul>
                            <li className="dropdown-item desc">
                              {subm.description === "TBD" ? (
                                <p>
                                  {" "}
                                  This area is still under construction! Please
                                  come back at a later time or{" "}
                                  <Link to="contact-us">Contact Us</Link> so we
                                  can notify you when this becomes available.
                                </p>
                              ) : (
                                subm.description
                              )}
